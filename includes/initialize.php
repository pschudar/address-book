...
define('MODAL_PATH', PROJECT_PATH . DS . 'includes' . DS . 'shared' . DS .  'modals' . DS);
# printing THIS_FILE in /public/staff/admins/show.php?id=someInteger prints 'show.php'
define('THIS_FILE', basename($php_self));
# printing THIS_DIR in /public/staff/admins/show.php prints 'admins'
define('THIS_DIR', basename(getcwd()));
