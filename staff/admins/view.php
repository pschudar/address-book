        ...
        <div class="my-3 p-3 bg-white rounded shadow">
            ...
            <div class="card-body text-center">
                ...
                <div class="card-text">
                    <address>
                        <?php
                        echo 'Role: ' . $entry->role_name;
                        ?>
                    </address>
                </div>
                <a href="<?php echo Utility::urlFor('/staff/admins/edit.php?id=') . $getId; ?>" class="btn btn-outline-secondary">Edit User</a>
                <div class="entry-created">
                    <p class="entry-date small text-muted">User Created: <?php echo Utility::formatDate($entry->date_created, 'm/d/Y'); ?></p>
                </div>
            </div>
