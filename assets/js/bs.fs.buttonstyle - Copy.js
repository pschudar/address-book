...
// FileStyle Button
    ...
    let fileList = [],
            ...
            //resetBtn = document.querySelector('#user-image-upload-form button#reset'),
                ...
                $.each(fileList, function (i, img) {
                    ...
                    allXHR.push($.ajax({
                        ...
                        error: function (data) {
                            ...
                            $('li#selImg').replaceWith(data.responseText);
                        ...
                        $.each(_messages, function (idx, msg) {
                            ...
                            $(('a.js-rm span:nth-child(2)')).eq(i).removeClass('text-danger').removeClass('os-times').addClass(statusIcon).addClass('text-' + color).text(' ' + statusTxt);
                            _messages = [];
                        });
                        $('#profileImage').load(location.href + " #profileImage>*", "");
                        $('#profileLinks').load(location.href + " #profileLinks>*", "");
    ...
    $(fileInput).on('change', function () {
        ...
        if ($('div#uploadCard').find('span#toggleLeft').hasClass('os-toggle-off')) {
